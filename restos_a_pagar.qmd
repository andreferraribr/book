...
![Figura 1. Manual de Demonstrativos Fiscais: Anexo 7 (Restos a Pagar)](relatorios_fiscais/rreo/formula_rp.png){alt="Figura 1. Manual de Demonstrativos Fiscais: Anexo 7 (Restos a Pagar)" fig-alt="Fórmula do RP a Pagar"}
...
![Figura 2: Reinscrição de Restos a Pagar](relatorios_fiscais/rreo/ano_empenho.png){alt="Figura 2: Reinscrição de Restos a Pagar"}
...
A partir do décimo segundo mês da série histórica, o pacote [dygraphs](https://rstudio.github.io/dygraphs/gallery-roll-periods.html) calcula a média móvel dividindo a soma dos saldos dos dozes meses por doze. De acordo com a Figura 3, em dezembro de 2008 o saldo suavizado era de R\$ 38,2 bilhões[^restos_a_pagar-1].

[^restos_a_pagar-1]: O Gráfico 7, com a média móvel, pode assumir os mesmos valores do Gráfico 6. Para tanto, basta mudar de 12 para 1 o valor no canto inferior esquerdo do gráfico (o número circulado em vermelho na Figura 2).

![Figura 3. Saldo em Dezembro/2008 (média móvel de 12 meses)](relatorios_fiscais/rreo/12_meses.png){alt="Figura 3. Saldo em Dezembro/2008 (média móvel de 12 meses)"}
