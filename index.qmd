...
A partir do gráfico 2 observamos um ponto de inflexão no ano de 2018. Entre 2019 e 2020 ocorre uma redução de aproximadamente 52% no estoque de RP a Pagar mais antigos (barra vermelha).
...
A partir do décimo segundo mês da série histórica, o pacote [dygraphs](https://rstudio.github.io/dygraphs/gallery-roll-periods.html) calcula a média móvel dividindo a soma dos saldos dos dozes meses por doze. A Figura 2 informa que em dezembro de 2008, o saldo suavizado era de R\$ 38,2 bilhões.

![Figura 2. Saldo em Dezembro/2008 (média móvel de 12 meses)](relatorios_fiscais/rreo/12_meses.png)
...
O Gráfico 7, com a média móvel, pode assumir os mesmos valores do Gráfico 6. Para tanto, basta mudar de 12 para 1 o valor no canto inferior do gráfico (o número circulado em vermelho na Figura 2).
